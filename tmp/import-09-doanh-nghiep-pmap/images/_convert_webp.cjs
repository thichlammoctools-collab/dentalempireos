...
const manifest = [{"index": 1, "src": "FHDubPgkloZRdMxR6l3jAnDfpQe", "name": "image.png", "local": "tmp/import-09-doanh-nghiep-pmap\\images\\img_01.png"}, {"index": 2, "src": "HbqgbPiquoSgdAxUgcojPrKrpQb", "name": "image.png", "local": "tmp/import-09-doanh-nghiep-pmap\\images\\img_02.png"}];
const results = {};
...
(async () => {
  ...
  fs.writeFileSync('tmp/import-09-doanh-nghiep-pmap\images\convert_output.json', JSON.stringify(results));
