...
const manifest = [{"index": 1, "src": "Zpsmb0vjgo5pqKxQzKgj4zHDpsd", "name": "image.png", "local": "tmp/import-32-ket-tang-3\\images\\img_01.png"}, {"index": 2, "src": "VvV2bstiJoer5gxdXFZjLCzypAd", "name": "image.png", "local": "tmp/import-32-ket-tang-3\\images\\img_02.png"}];
const results = {};
...
(async () => {
  ...
  fs.writeFileSync('tmp/import-32-ket-tang-3\images\convert_output.json', JSON.stringify(results));
