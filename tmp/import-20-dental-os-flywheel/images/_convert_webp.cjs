...
const manifest = [{"index": 1, "src": "W25LbZgAsoEiShxWRSrjcwE7pPd", "name": "image.png", "local": "tmp/import-20-dental-os-flywheel\\images\\img_01.png"}];
const results = {};
...
(async () => {
  ...
  fs.writeFileSync('tmp/import-20-dental-os-flywheel\images\convert_output.json', JSON.stringify(results));
