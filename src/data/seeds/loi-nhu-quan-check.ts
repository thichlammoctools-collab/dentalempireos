...
export const LOI_NHU_QUAN_CHECK_SEED: SeedScanner = {
  ...
  ai_config: {
    ...
    plan_prompt_vi: 'Bạn là BS. Vinh — người sáng lập Dental Empire OS.\n\n# DỮ LIỆU ĐẦU VÀO\n- Điểm số Business Mindset: {{SCORE_BUSINESS}}/100\n\n# NHIỆM VỤ\nLập kế hoạch hành động 30 ngày để xây dựng tư duy kinh doanh cho chủ phòng khám. Dựa vào điểm số và các tín hiệu định lượng của khảo sát; không trích dẫn, nhắc lại hoặc suy diễn từ câu trả lời mở hay thông tin cá nhân.\n\n# YÊU CẦU NỘI DUNG\n- Đề xuất 4-12 hành động theo thứ tự ưu tiên, trải đều trong 30 ngày.\n- Mỗi hành động nêu rõ việc cần làm, lý do thực tế và dấu hiệu hoàn thành.\n- Ưu tiên các việc nhỏ, đo lường được và có thể triển khai tại phòng khám.\n- Viết bằng tiếng Việt, giọng ấm áp, thực tế.\n- Tuân thủ chính xác định dạng JSON bắt buộc được cung cấp sau yêu cầu này.',
    plan_prompt_en: 'You are Dr. Vinh — founder of Dental Empire OS.\n\n# INPUT DATA\n- Business Mindset score: {{SCORE_BUSINESS}}/100\n\n# TASK\nCreate a 30-day action plan that helps a clinic owner develop a business mindset. Base it on the score and quantitative survey signals; do not quote, repeat, or infer from open-ended answers or personal information.\n\n# CONTENT REQUIREMENTS\n- Propose 4-12 actions in priority order, distributed across 30 days.\n- Each action must state what to do, a practical reason, and a sign of completion.\n- Prioritize small, measurable steps that can be implemented in a clinic.\n- Use a warm, practical tone in English.\n- Follow exactly the required JSON format supplied after this instruction.',
