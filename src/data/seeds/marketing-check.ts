...
export const MARKETING_CHECK_SEED: SeedScanner = {
  ...
  description_vi: 'Không có marketing = không có bệnh nhân mới. 5 câu hỏi giúp bạn đánh giá chiến lược tiếp cận và giữ chân bệnh nhân của phòng khám.',
  description_en: 'No marketing = no new patients. 5 questions to assess your patient acquisition and retention strategy.',
  ...
  translations_vi: { submitButton: 'Xem kết quả', submitting: 'Đang xử lý...', required: 'bắt buộc', start: 'Bắt đầu →', back: '← Quay lại', next: 'Tiếp tục →', prev: '← Quay lại', intro_title: 'Marketing Check', intro_desc: 'Không có marketing = không có bệnh nhân mới. 5 câu hỏi giúp bạn đánh giá chiến lược tiếp cận và giữ chân bệnh nhân của phòng khám.', restore_draft: 'Bạn có bản nháp chưa hoàn thành.', clear_draft: 'Xoá & bắt đầu lại', submit_title: 'Sẵn sàng xem kết quả?', submit_desc: 'Hệ thống sẽ tính điểm và hiển thị ngay.', step_label: 'Phần', submit_label: 'Gửi' },
  translations_en: { submitButton: 'See Result', submitting: 'Processing...', required: 'required', start: 'Start →', back: '← Back', next: 'Next →', prev: '← Back', intro_title: 'Marketing Check', intro_desc: 'No marketing = no new patients. 5 questions to assess your patient acquisition and retention strategy.', restore_draft: 'You have an unfinished draft.', clear_draft: 'Clear & start over', submit_title: 'Ready to see results?', submit_desc: 'We will calculate and display your score immediately.', step_label: 'Part', submit_label: 'Submit' },

  scoring_rules: {
    dimensions: [{ id: 'marketing', name_vi: 'Chiến lược Marketing', name_en: 'Marketing Strategy', question_ids: ['mkt_q1', 'mkt_q2', 'mkt_q3', 'mkt_q4'], formula: 'avg' }],
    total_formula: 'average',
    thresholds: { excellent: 75, good: 55, needs_work: 35, critical: 0 },
  },

  ai_config: {
    prompt_vi: 'Bạn là BS. Vinh — chuyên gia tư vấn phòng khám nha khoa. Dựa trên kết quả Marketing Check (điểm {{SCORE_MARKETING}}/100 và câu trả lời open), phân tích ngắn gọn chiến lược marketing và đưa ra 3 hành động cải thiện trong tháng tới. Dùng tiếng Việt, giọng thẳng thắn ấm áp.',
    prompt_en: 'You are Dr. Vinh — dental clinic management consultant. Based on the Marketing Check score ({{SCORE_MARKETING}}/100 and open answer), briefly analyze your marketing strategy and suggest 3 improvement actions. English, candid and warm tone.',
    model_override: null, max_tokens_override: 2048,
  },

  sections: [{
    order_idx: 0,
    title_vi: '5 CÂU HỎI VỀ MARKETING',
    title_en: '5 QUESTIONS ABOUT MARKETING',
    subtitle_vi: 'Nhìn thẳng vào thực tế — bệnh nhân đến từ đâu?',
    subtitle_en: 'Face the reality — where do patients come from?',
    ...
    questions: [
      ...
      { question_id: 'mkt_q5', order_idx: 4, type: 'textarea', label_vi: 'Kênh marketing nào đang hoạt động tốt nhất và kênh nào đang lãng phí ngân sách?', label_en: 'Which marketing channel is working best and which is wasting budget?', placeholder_vi: 'Liệt kê 1-2 kênh hiệu quả nhất và 1-2 kênh cần cải thiện hoặc loại bỏ.', placeholder_en: 'List 1-2 best performing channels and 1-2 that need improvement or removal.' },
    ],
  }],
};
