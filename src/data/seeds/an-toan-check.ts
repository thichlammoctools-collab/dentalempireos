...
export const AN_TOAN_CHECK_SEED: SeedScanner = {
  ...
  description_vi: 'An toàn là nền tảng không thể thương lượng. 5 câu hỏi giúp bạn đánh giá mức độ tuân thủ quy chuẩn an toàn trong phòng khám.',
  description_en: 'Safety is non-negotiable. 5 questions to assess your clinic safety compliance level.',
  ...
  translations_vi: { submitButton: 'Xem kết quả', submitting: 'Đang xử lý...', required: 'bắt buộc', start: 'Bắt đầu →', back: '← Quay lại', next: 'Tiếp tục →', prev: '← Quay lại', intro_title: 'An Toàn Check', intro_desc: 'An toàn là nền tảng không thể thương lượng. 5 câu hỏi giúp bạn đánh giá mức độ tuân thủ và an toàn trong phòng khám.', restore_draft: 'Bạn có bản nháp chưa hoàn thành.', clear_draft: 'Xoá & bắt đầu lại', submit_title: 'Sẵn sàng xem kết quả?', submit_desc: 'Hệ thống sẽ tính điểm và hiển thị ngay.', step_label: 'Phần', submit_label: 'Gửi' },
  translations_en: { submitButton: 'See Result', submitting: 'Processing...', required: 'required', start: 'Start →', back: '← Back', next: 'Next →', prev: '← Back', intro_title: 'Safety Check', intro_desc: 'Safety is non-negotiable. 5 questions to assess your clinic safety compliance level.', restore_draft: 'You have an unfinished draft.', clear_draft: 'Clear & start over', submit_title: 'Ready to see results?', submit_desc: 'We will calculate and display your score immediately.', step_label: 'Part', submit_label: 'Submit' },

  scoring_rules: {
    dimensions: [{ id: 'safety', name_vi: 'An toàn & Tuân thủ', name_en: 'Safety & Compliance', question_ids: ['at_q1', 'at_q2', 'at_q3', 'at_q4'], formula: 'avg' }],
    total_formula: 'average',
    thresholds: { excellent: 75, good: 55, needs_work: 35, critical: 0 },
  },

  ai_config: {
    prompt_vi: 'Bạn là BS. Vinh — chuyên gia tư vấn phòng khám nha khoa. Dựa trên kết quả An Toàn Check (điểm {{SCORE_SAFETY}}/100 và câu trả lời open), phân tích ngắn gọn mức độ tuân thủ an toàn và đưa ra 3 hành động ưu tiên để cải thiện trong tháng tới. Dùng tiếng Việt, giọng thẳng thắn ấm áp.',
    prompt_en: 'You are Dr. Vinh — dental clinic management consultant. Based on the Safety Check score ({{SCORE_SAFETY}}/100 and open answer), briefly analyze safety compliance and suggest 3 priority actions. English, candid and warm tone.',
    model_override: null, max_tokens_override: 2048,
  },

  sections: [{
    order_idx: 0,
    title_vi: '5 CÂU HỎI VỀ AN TOÀN',
    title_en: '5 QUESTIONS ABOUT SAFETY',
    subtitle_vi: 'Trả lời trung thực — an toàn không có chỗ cho sai sót.',
    subtitle_en: 'Answer honestly — safety leaves no room for error.',
    ...
    questions: [
      ...
      { question_id: 'at_q5', order_idx: 4, type: 'textarea', label_vi: 'An toàn nào là "lỗ hổng" lớn nhất của phòng khám hiện tại?', label_en: 'What is the biggest safety gap in your clinic right now?', placeholder_vi: 'Mô tả ngắn gọn — giấy phép, vô trùng, PCCC, quản lý thuốc, hay đào tạo nhân sự?', placeholder_en: 'Brief description — license, sterilization, fire safety, drug management, or staff training?' },
    ],
  }],
};
