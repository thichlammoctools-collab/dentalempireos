...
const DEFAULTS: Omit<HomepageSettings, 'id' | 'updated_at'> = {
  ...
  hero_cta_primary: 'Đọc tài liệu miễn phí ngay',
  ...
  testimonial2_quote: 'Kiến thức về Marketing và Tài chính trong tài liệu rất thực chiến. Tôi đã áp dụng ngay và thấy doanh thu tăng trưởng rõ rệt chỉ sau 3 tháng.',
  ...
  cta_subtext: 'Khám phá khung quản trị và xem trước nội dung tài liệu trước khi quyết định.',
