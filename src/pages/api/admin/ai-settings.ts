...
export const GET: APIRoute = async ({ locals }) => {
  ...
  return json({
    ...
    motapis_image_model: settings.motapis_image_model ?? '',
...
export const POST: APIRoute = async ({ request, locals }) => {
  ...
  for (const field of ['motapis_model', 'motapis_scanner_model', 'motapis_chat_model', 'motapis_image_model'] as const) {
    ...
    settings: {
       ...
       gateway_id: updated.gateway_id,
        ...
        motapis_model: updated.motapis_model ?? '',
         ...
         motapis_image_model: updated.motapis_image_model ?? '',
        motapis_api_key_set: hasMotapisApiKey(),
