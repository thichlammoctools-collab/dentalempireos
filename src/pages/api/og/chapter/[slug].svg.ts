...
import { getChapter } from '../../../../lib/book-db';
import { getTierLabel } from '../../../../lib/collection-helpers';

export const prerender = false;

// SVG dimensions (standard OG image: 1200x630)
const W = 1200;
const H = 630;
...
const TIER_PALETTE: Record<number, { bar: string; pill: string; subtle: string }> = {
...
export const GET: APIRoute = async ({ params }) => {
  ...
  let chapter: { title: string; description: string | null; tier: number; chapter_no: number } | null = null;
  try {
