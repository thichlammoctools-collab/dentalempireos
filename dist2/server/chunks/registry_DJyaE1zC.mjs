...
import { K as KHO_VAT_TU_CHECK_SEED, D as DO_LUONG_CHECK_SEED, R as REFERRAL_CHECK_SEED, C as CONTENT_FUNNEL_CHECK_SEED, S as STARTUP_CHECK_SEED } from "./kho-vat-tu-check_Bt0ARmJa.mjs";
...
const SEED_REGISTRY = {
  ...
  [STARTUP_CHECK_SEED.id]: STARTUP_CHECK_SEED,
  [CONTENT_FUNNEL_CHECK_SEED.id]: CONTENT_FUNNEL_CHECK_SEED,
  [REFERRAL_CHECK_SEED.id]: REFERRAL_CHECK_SEED,
  [DO_LUONG_CHECK_SEED.id]: DO_LUONG_CHECK_SEED,
  [KHO_VAT_TU_CHECK_SEED.id]: KHO_VAT_TU_CHECK_SEED
};
export {
  SEED_REGISTRY as S
};
