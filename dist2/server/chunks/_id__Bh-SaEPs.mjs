...
import { g as getSurveyDefinitionFull, c as parseScoringRules, d as parseAiConfig, p as parseScaleLabels } from "./survey-config-db_AxTlbaW3.mjs";
import { g as getScannerResponse, p as parseScores, j as getScoreLevel, a as parseResponses } from "./scanner-response-db_wxssrRMk.mjs";
...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const planStatus = response.ai_plan_status ?? "pending";
  const analysisStatus = response.ai_analysis_status ?? "pending";
