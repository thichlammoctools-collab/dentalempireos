...
const HO_SO_GOC_RE_SEED = {
  id: "ho-so-goc-re",
  slug: "ho-so-goc-re",
  title_vi: "Hồ Sơ Gốc Rễ",
  title_en: "Roots Profile",
  description_vi: "Trước khi bắt đầu hành trình, hãy quay về gốc rễ. Khảo sát này giúp bạn và tư vấn viên thấy rõ bản sắc, giá trị và năng lực hiện có của phòng khám.",
  description_en: "Before starting the journey, let's return to the roots. This survey helps you and your consultant clearly see the identity, values, and current capabilities of your clinic.",
