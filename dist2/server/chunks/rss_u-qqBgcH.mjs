...
import { o as object, g as string, n as number, h as array, i as union, j as date, k as boolean, l as record, p as s, q as preprocess, _ as _function, t as promise, v as any, w as unknown } from "./sequence_CNN-ZGRA.mjs";
...
async function GET(context) {
  ...
  return getRssResponse({
    ...
    items: posts.map((post) => {
      const html = sanitizeRichHtml(g.parse(post.content_md ?? ""));
      return {
        title: post.title,
        link: `/blog/${post.slug}/`,
        ...
        customData: post.cover_url ? `<enclosure url="${post.cover_url}" type="image/jpeg" length="0" />` : ""
      };
    })
  });
}
